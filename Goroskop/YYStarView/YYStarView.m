...
- (void)setStarImage {
    ...
    if (!self.starBrightImageName) {
        self.starBrightImageName = @"star";
    }

    if (!self.starDarkImageName) {
        self.starDarkImageName = @"darkStar";
    }
    ...
    if (starBrightImage == nil) {
        starBrightImage = [UIImage imageNamed:@"star" inBundle:resourcesBundle compatibleWithTraitCollection:nil];
        starBrightHighlightedImage = nil;
    }
    
    if (starDarkImage == nil) {
        starDarkImage = [UIImage imageNamed:@"darkStar" inBundle:resourcesBundle compatibleWithTraitCollection:nil];
